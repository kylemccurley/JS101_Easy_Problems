function wantToVisit(museum, city) {
  return museum.includes('Computer') || museum.includes('Science') && !(museum.includes('Modern') && museum.includes('Art') && museum.includes('Andy Warhol') || city === 'Amsterdam');
}
...
console.log(wantToVisit('NEMO Science Museum', 'Amsterdam') === true); // Wrong (Returning false)
console.log(wantToVisit('National Museum of Modern Art', 'Paris') === false);
console.log(wantToVisit('Andy Warhol Museum of Modern Art', 'Medzilaborce') === true); // Wrong (Returning false)
console.log(wantToVisit('Moco: Modern Contemporary Art', 'Amsterdam') === true); // Wrong (Returning false)
